...
export default function MenteeForm({ onSaved, onCancel }) {
  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
      <h3 className="font-semibold text-gray-800 mb-4">Neuen Mentee anlegen</h3>
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <p className="text-xs text-gray-400 mt-1">Du vergibst das Passwort — teile es direkt mit dem Mentee.</p>
        </div>
